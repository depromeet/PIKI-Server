...
// - failureByCode: 실패 토큰을 FcmFailureCode(타입 안전)별로 센 맵.
data class FcmSendResult(
    val staleTokens: List<String>,
    val successCount: Int,
    val failureByCode: Map<FcmFailureCode, Int>,
) {
    ...
    val dominantFailureCode: FcmFailureCode? get() = failureByCode.maxByOrNull { it.value }?.key
